...
export const servicesFelicia = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Manichiura cu oja semi permanenta, cu apex sau fara (in funcție de tipologia unghiilor).",
        price: "105 RON",
        duration: "1h 20m",
      },
      {
    ...
    items: [
      {
        ...
        description:
          "Tratament pentru picioare cu ajutorul unui dispozitiv profesional, urmat de aplicarea lacului de unghii.",
        price: "85 RON",
        duration: "30m",
      },
      {
        ...
        description:
          "Tratament pentru tălpi, care sunt mai întâi cufundate într-o baie fierbinte. Acesta include și aplicarea unui lac de unghii, care rezistă câteva săptămâni.",
        price: "105 - 140 RON",
        duration: "45m",
      },
      {
    ...
    <div className="min-h-screen bg-gradient-to-br from-background to-muted/20 p-8 select-none">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-12">
          {servicesFelicia.map((category, categoryIndex) => (
            <div
              key={categoryIndex}
              className="bg-card/50 backdrop-blur-sm rounded-2xl border border-border/50 shadow-lg overflow-hidden"
            >
              {/* Category Header */}
              ...
              <div className="p-8">
                <div className="space-y-6">
                  {category.items.map((service, serviceIndex) => (
                    <div
                      key={serviceIndex}
                      className="group hover:bg-muted/30 rounded-xl p-6 transition-all duration-300 border border-transparent hover:border-border/50"
                    >
        ...
        <div className="mt-12 text-center">
          <div className="bg-card/30 backdrop-blur-sm rounded-xl border border-border/30 p-6">
            <p className="text-muted-foreground text-sm">
              <span className="font-semibold text-foreground">Notă:</span>{" "}
              Prețurile pot varia în funcție de complexitatea serviciului.
              Pentru programări și informații suplimentare, vă rugăm să ne
              contactați.
            </p>
          </div>
        </div>
